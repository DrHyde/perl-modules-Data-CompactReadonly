...
is(Data::CROD->read($fh), 65, "can read from in-memory file handle");
seek($fh, 0, SEEK_SET);
is(Data::CROD->read($fh), 65, "can re-read from in-memory file handle after seeking back to beginning");
close($fh);
