package Data::CROD::V0::Collection;

use warnings;
use strict;
use base 'Data::CROD::V0::Node';

use Scalar::Util qw(blessed);
use Data::CROD::V0::Scalar;
...
sub _encode_ptr {
    my($class, %args) = @_;
    return Data::CROD::V0::Scalar->_encode_word_as_number_of_bytes(
        $args{pointer}, 
        $args{ptr_size}
    );
}
...
sub _decode_ptr {
    goto &Data::CROD::V0::Scalar::_decode_word;
}
